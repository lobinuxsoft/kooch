...
handle drags in? Godot moves it, and extruding a wall's face against a floor grid
tells you nothing — but it is more work, and it is a decision rather than a
detail.

Then #1080's other half (vertex and edge), #1086 triplanar **before** #1069's
glTF export, and #1087's free list, which extrude makes more visible.
