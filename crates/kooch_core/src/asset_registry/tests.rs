...
/// The registry has to be non-empty in a binary that links any crate declaring an asset — an empty
/// inventory reads as "no asset types" and would make every check below vacuously pass.
#[test]
