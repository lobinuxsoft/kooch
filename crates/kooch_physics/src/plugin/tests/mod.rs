...
fn world() -> Resources {
    ...
    registry.register_cpu_reflected::<kooch_ecs::hierarchy::GlobalTransform>();
    r
}
...
fn insert<T: kooch_ecs::component::Component>(resources: &mut Resources, entity: Entity, value: T) {
