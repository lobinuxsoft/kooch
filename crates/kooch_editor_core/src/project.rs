...
// AUTO-GENERATED by the Kóoch editor — do not edit by hand.
// Regenerated when you create or register components / systems.
#![allow(unused_imports, unused_variables, dead_code)]

use kooch::kooch_ecs::component::ComponentRegistry;
use kooch::prelude::*;
...
pub fn declare_components(engine: &mut dyn kooch::kooch_plugin_api::Engine) {
    use kooch::kooch_ecs::component::plugin_bridge::declare_component;
}
";
