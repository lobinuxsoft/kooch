...
fn attach(resources: &mut ome_core::resource::Resources, parent: Entity, child: Entity) {
...
fn set_global(resources: &mut ome_core::resource::Resources, entity: Entity, matrix: glam::Mat4) {
