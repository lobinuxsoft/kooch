...
impl PopulatePass {
    ...
    pub fn new(
        ...
        let populate_module = device.create_shader_module(wgpu::ShaderModuleDescriptor {
            label: Some("ome_world::voxel::populate::populate_shader"),
        ...
        let populate_pipelines = std::array::from_fn(|lod_idx| {
            ...
            let label = format!("ome_world::voxel::populate::populate_pipeline_lod{lod_idx}");
        ...
        let finalize_pipeline = device.create_compute_pipeline(&wgpu::ComputePipelineDescriptor {
            label: Some("ome_world::voxel::populate::finalize_pipeline"),
        ...
        let uniform_buffer = device.create_buffer(&wgpu::BufferDescriptor {
            label: Some("ome_world::voxel::populate::uniform"),
    ...
    pub fn record(
...

        {
            let mut pass = encoder.begin_compute_pass(&wgpu::ComputePassDescriptor {
                label: Some("ome_world::voxel::populate::finalize_pass"),
        ...
        {
            let mut pass = encoder.begin_compute_pass(&wgpu::ComputePassDescriptor {
                label: Some("ome_world::voxel::populate::populate_pass"),
                timestamp_writes: None,
            });
    ...
    fn create_populate_bg(
        ...
        let label = format!("ome_world::voxel::populate::populate_bg_lod{lod_idx}");
    ...
    fn create_finalize_bg(
        ...
        let label = format!("ome_world::voxel::populate::finalize_bg_lod{lod_idx}");
        device.create_bind_group(&wgpu::BindGroupDescriptor {
            label: Some(&label),
