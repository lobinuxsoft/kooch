...
impl ClassifyPass {
    ...
    pub fn new(
        ...
        let classify_module = device.create_shader_module(wgpu::ShaderModuleDescriptor {
            label: Some("ome_world::voxel::classify::classify_shader"),
            source: wgpu::ShaderSource::Wgsl(classify_src.into()),
        });

        let classify_pipelines = std::array::from_fn(|lod_idx| {
            let label = format!("ome_world::voxel::classify::classify_pipeline_lod{lod_idx}");
        ...
        let uniform_buffer = device.create_buffer(&wgpu::BufferDescriptor {
            label: Some("ome_world::voxel::classify::uniform"),
    ...
    pub fn record(
        ...
        let mut pass = encoder.begin_compute_pass(&wgpu::ComputePassDescriptor {
            label: Some("ome_world::voxel::classify::classify_pass"),
    ...
    fn create_classify_bg(
        ...
        let label = format!("ome_world::voxel::classify::classify_bg_lod{lod_idx}");
