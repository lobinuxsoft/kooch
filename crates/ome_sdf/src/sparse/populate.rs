...
impl PopulatePass {
    ...
    pub fn new(
        ...
        let populate_pipelines = std::array::from_fn(|lod_idx| {
            ...
            let label = format!("ome_sdf::sparse::populate::populate_pipeline_lod{lod_idx}");
    ...
    fn create_populate_bg(
        ...
        let label = format!("ome_sdf::sparse::populate::populate_bg_lod{lod_idx}");
    ...
    fn create_finalize_bg(
        ...
        let label = format!("ome_sdf::sparse::populate::finalize_bg_lod{lod_idx}");
        device.create_bind_group(&wgpu::BindGroupDescriptor {
            label: Some(&label),
