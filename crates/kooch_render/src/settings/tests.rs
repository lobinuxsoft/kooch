...
fn the_shadow_bias_reaches_the_settings() {
    ...
    // 🔴 ON, unlike the cap above. That one is a distance nobody has
    // measured for a given scene; this one is an angle the geometry
    // fixes, and shipping it at 0 would ship #1017 unfixed behind a
