...
const CULL_SHADER_SOURCE: &str = concat!(
    ...
    // 🔴 LAST, and that is a dependency and not a preference: the chunked entries call
    // `lod_group_max_err` and `cull_pool_atomic` out of `atomic.wgsl`, and WGSL wants a function
