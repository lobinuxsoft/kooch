//! ome_window - Windowing system for OhMyEngine.
//!
...
/// use ome_window::{WindowPlugin, WindowHandle};
///
/// App::new()
///     .add_plugins(MinimalPlugins)
...
mod tests {
    ...
    use ome_core::plugin::MinimalPlugins;

    #[test]
    fn window_config_default() {
        let config = WindowConfig::default();
        assert_eq!(config.title, "Oh My Engine");
